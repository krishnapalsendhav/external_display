package com.krishnapal.external_display
...
class ExternalDisplayPlugin : FlutterPlugin, ActivityAware, MethodChannel.MethodCallHandler {

  private lateinit var channel: MethodChannel
  private lateinit var eventChannel: EventChannel
  private var flutterEngineChannel: MethodChannel? = null
  private var context: Context? = null
  private var presentation: ExternalDisplay? = null
        ...
        try {
          ...
          if (display != null) {
            ...
            flutterEngine?.let {
              ...
              presentation = context?.let { it1 -> ExternalDisplay(it1, tag, display) }
